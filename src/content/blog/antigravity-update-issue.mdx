...
tags: ["Google Antigravity", "Antigravity IDE", "Developer Tools", "Workspaces", "Bug Fix", "AEO"]
faq:
...
> [!NOTE]
> **Quick Answer (TL;DR):** If your Antigravity IDE sidebar or file explorer disappeared after the 2.0.1+ update:
...
<div className="blog-card border blog-border rounded-xl p-8 my-10 text-center">
  ...
  <ArticleCTALink slug="antigravity-update-issue" />
</div>
