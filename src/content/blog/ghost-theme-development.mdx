...
This is the kind of audit I run before delivering any Ghost theme work to clients. **If you've inherited a Ghost theme someone else built and things are breaking, I offer a [theme health check](/#contact) as part of my customization service.**

<ArticleCTALink slug="ghost-theme-development" />
