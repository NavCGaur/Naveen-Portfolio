...
Workarounds like these are exactly the kind of thing I help Ghost Pro clients with — finding what's achievable within the platform constraints, without needing to migrate to self-hosted. **If you're hitting Ghost Pro limits, [let's talk](/#contact).**

<ArticleCTALink slug="ghost-staff-roles-pro" />
