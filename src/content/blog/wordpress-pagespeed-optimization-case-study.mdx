...
The client operates a somatic trauma healing practice (`katgrace.com`). Because trauma therapy is highly personal and requires establishing immediate clinical trust, the website's design is heavily visual, featuring high-resolution images.
...
We implemented a three-phased technical tuning strategy:
...
After replacing the hero image with the optimized WebP file (`Kat-grace-photo.webp`), the mobile score dropped, showing a 4.3-second delay.
