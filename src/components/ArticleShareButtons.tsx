...
export default function ArticleShareButtons({ slug, title }: ArticleShareButtonsProps) {
  ...
  return (
    ...
    >
      <span style={{ fontSize: "12px", color: "var(--bt-text-faint)", letterSpacing: "0.08em", textTransform: "uppercase", marginRight: "4px" }}>
        Share
      </span>

      {/* Twitter / X */}
      <button onClick={shareTwitter} style={btnBase} aria-label="Share on X (Twitter)">
      ...
      {/* LinkedIn */}
      <button onClick={shareLinkedIn} style={btnBase} aria-label="Share on LinkedIn">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
