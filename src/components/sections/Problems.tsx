        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {problems.map((p, i) => (
            <motion.div
              ...
              onClick={() => ga.event({ action: "pain_point_click", category: "engagement", label: p.title })}
              className="relative overflow-hidden bg-[#141414] hover:bg-[#1a1a1a] border border-white/[0.06] hover:border-gold/30 rounded-xl transition-all duration-300 p-10 py-16 min-h-[360px] flex flex-col justify-center group cursor-pointer"
            >
