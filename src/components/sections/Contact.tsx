...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-[100px] px-6 md:px-10 hd:px-14 bg-ink text-white">
      <div className="max-w-[1100px] hd:max-w-[1280px] mx-auto">
        ...
        >
          <span className="block text-[13px] font-medium tracking-[0.08em] uppercase text-gold mb-4">
            Work Together
          </span>
          <h2 className="font-serif font-bold text-[clamp(28px,4vw,40px)] tracking-[-0.01em] leading-[1.1] mb-5 max-w-[600px] mx-auto">
            Got a problem? Let&apos;s talk honestly about it.
          </h2>
          <p className="text-[17px] text-white/50 leading-[1.7] font-normal max-w-[460px] mx-auto mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            {submitStatus === "success" ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <button
                  ...
                  className="group relative overflow-hidden w-full bg-gold text-ink px-6 py-3 rounded-sm text-[16px] font-medium hover:bg-gold-light transition-colors duration-300 disabled:opacity-70 disabled:cursor-not-allowed mt-2"
                >
                  <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-ink to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out z-0" />
          ...
          >
            <div>
              <div className="text-[13px] tracking-[0.05em] uppercase text-white/60 mb-2">Email</div>
            ...
            <div>
              <div className="text-[13px] tracking-[0.05em] uppercase text-white/60 mb-2">Phone / WhatsApp</div>
              <div className="text-[17px] text-white/80 font-medium">+91 99208 99845</div>
            </div>
