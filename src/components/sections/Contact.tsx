      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        >
          ...
          <a
            ...
            className="group relative overflow-hidden inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-8 py-3.5 rounded-sm text-[15px] font-medium tracking-[0.02em] hover:bg-[#20bd5a] transition-all duration-300 shadow-lg shadow-[#25D366]/20"
          >
            ...
            {submitStatus === "success" ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <button
                  ...
                  className="group relative overflow-hidden w-full bg-gold text-ink px-6 py-3 rounded-sm text-[15px] font-medium hover:bg-gold-light transition-colors duration-300 disabled:opacity-70 disabled:cursor-not-allowed mt-2"
                >
