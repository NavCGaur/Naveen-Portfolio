      ...
      <div className="max-w-[1100px] hd:max-w-[1280px] mx-auto text-center">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6">
            ...
            <span className="inline-flex items-center gap-2 text-[12px] font-medium tracking-[0.1em] uppercase  group-hover:text-gold-dark transition-colors duration-300 mt-2 md:mt-0">
